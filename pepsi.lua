...
local library = {
	...
	colors = {
		main = Color3.fromRGB(255, 51, 153),
		background = Color3.fromRGB(19, 0, 7),
		outerBorder = Color3.fromRGB(0, 0, 0),
		innerBorder = Color3.fromRGB(165, 13, 84),
		topGradient = Color3.fromRGB(0, 0, 0),
		bottomGradient = Color3.fromRGB(54, 0, 25),
		sectionBackground = Color3.fromRGB(34, 0, 16),
		section = Color3.fromRGB(255, 51, 153),
		otherElementText = Color3.fromRGB(191, 191, 191),
		elementText = Color3.fromRGB(191, 191, 191),
		elementBorder = Color3.fromRGB(34, 0, 16),
		selectedOption = Color3.fromRGB(27, 0, 13),
		unselectedOption = Color3.fromRGB(27, 0, 13),
		hoveredOptionTop = Color3.fromRGB(27, 0, 13),
		unhoveredOptionTop = Color3.fromRGB(27, 0, 13),
		hoveredOptionBottom = Color3.fromRGB(27, 0, 13),
		unhoveredOptionBottom = Color3.fromRGB(27, 0, 13),
